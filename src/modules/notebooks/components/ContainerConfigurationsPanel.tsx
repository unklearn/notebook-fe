...
const ContainerConfigurationDetails: React.FC<ContainerConfigurationDetailsProps> =
  ({ config, onFileAdd, onDocAdd, onCommandRun }) => {
    ...
    return (
      <div className="unk-container-configuration-details box">
        ...
        <div className="field">
          <label className="label">Execute command</label>
          <div className="control">
            <input
              id={commandExecInputId}
              className="input"
              type="text"
    ...
    <div className="unk-container-configuration-details box">
      ...
      <form onSubmit={_handleSubmit}>
        ...
        <div className="field">
          ...
          <div className="control">
            <input
              ...
              onChange={(e) =>
                setConfig({ ...config, startCommand: e.target.value })
              }
              placeholder="Enter container start command"
            />
          </div>
        </div>
        ...
        <div className="field">
          ...
          <div className="control">
            <input
              ...
              placeholder="Enter ports to be exposed separated by whitespace"
            />
          </div>
        </div>
        ...
        <div className="field is-grouped">
          <div className="control">
            <button onSubmit={_handleSubmit} className="button is-link">
              Save
            </button>
          </div>
          <div className="control">
