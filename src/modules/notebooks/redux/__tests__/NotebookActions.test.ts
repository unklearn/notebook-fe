import { createNotebookAction, createNotebookFailureAction, createNotebookSuccessAction, NOTEBOOK_CREATE_ACTION_TYPE, NOTEBOOK_CREATE_FAILURE_ACTION_TYPE, NOTEBOOK_CREATE_SUCCESS_ACTION_TYPE } from "../NotebookActions";

const notebook = {id: 'foo', name: 'foo', description: 'desc'};
