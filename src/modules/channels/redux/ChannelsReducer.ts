...
function handleChannelMessageReducer(state: NotebookChannelReduxState, action: WebsocketMessageAction): NotebookChannelReduxState {
 ...
 */
export function channelsReducer(state: NotebookChannelReduxState = INITIAL_STATE, action: ChannelActionTypes): NotebookChannelReduxState {
    switch (action.type) {
